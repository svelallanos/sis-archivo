...
class ReporteCategoria extends FPDF
{
    ...
    public function __construct($categoria, $headerData)
    {
        parent::__construct();
    ...
    public function generarReporte()
    {
        ...
        $this->Cell(0, 10, mb_convert_encoding('REPORTE DE CATEGORÍA', "ISO-8859-1", "UTF-8"), 0, 1, 'C');
        $this->Ln(5);
        ...
        $this->agregarCampo('Nombre:', $this->categoria['name']);
        $this->agregarCampo('Código:', '#' . $this->categoria['idCategory']);
        $this->agregarCampo('Descripción:', $this->categoria['description'], true);
        $this->agregarCampo('Estado:', $this->categoria['status']);
        $this->Ln(5);
        ...
        $this->SetTextColor(0, 0, 0);
        $this->agregarCampo('Fecha de registro:', $this->categoria['dateRegistration']);
        $this->agregarCampo('Fecha de actualización:', $this->categoria['dateUpdate']);
    }
