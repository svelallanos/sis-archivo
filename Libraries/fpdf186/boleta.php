...
class boleta extends FPDF
{
    ...
    function DetalleProductos()
    {
        ...
        $this->Cell(40, 8, $this->datos_boleta['currency'] . " " . $this->datos_boleta['total'], 1, 1, 'R', true);

        $this->SetFont('Arial', 'I', 9);
        $this->Cell(190, 6, utf8_decode('SON: ' . strtoupper(convertirNumeroLetras($this->datos_boleta['total']))), 0, 1, 'L');
    }
}
