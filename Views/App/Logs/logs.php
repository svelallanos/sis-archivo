...
<main class="app-content">
    <div class="app-title pt-5">
        <div>
            <h1><i class="fa fa-microchip"></i> <?= $data["page_title"] ?></h1>
            <p><?= $data["page_description"] ?></p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-microchip"></i></i></li>
            <li class="breadcrumb-item"><a href="<?= base_url() ?>/logs"><?= $data["page_title"] ?></a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="d-flex justify-content-center  align-items-center">
                    <h3 class="text-uppercase font-weight-bold text-primary" id="reportTitle">Titulo del registro</h3>
                </div>
                <!-- Datos Personales -->
