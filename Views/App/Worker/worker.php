    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="modalSaveLabel">Registro del trabajador</h5>
            ...
            <div class="modal-body">
                ...
                <div class="tile-body">
                    <form id="formSave" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input class="form-control" type="text" id="txtDni" name="txtDni" required
                                    placeholder="Ingrese el DNI o RUC de una persona" maxlength="11" minlength="8"
                        ...
                        <div class="form-group">
                            <label class="control-label" for="selectJobtitle">Cargo:</label>
                            <span class="text-danger">*</span>
                            <select id="selectJobtitle" name="selectJobtitle" class="form-control" required>
                                <option value="">Seleccione un cargo</option>
                                <?php foreach ($data['jobtitle'] as $jobtitle) : ?>
                                    <option value="<?= $jobtitle['id'] ?>"><?= $jobtitle['name'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <small class="form-text text-muted">
                                Selecciona el cargo. Si no hay un cargo disponible, por favor crea uno nuevo.
                            </small>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="control-label" for="txt_Accountnumber">Número de cuenta 1:</label>
                                    <span class="text-danger">*</span>
                                    <div class="input-group">
                                ...
                                <div class="col-md-6">
                                    <label class="control-label" for="txt_Accountnumber2">Número de cuenta 2:</label>
                                    <div class="input-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="control-label" for="txt_Accountnumber3">Número de cuenta 3:</label>
                                    <div class="input-group">
                                        <input type="text" id="txt_Accountnumber3" name="txt_Accountnumber3" class="form-control">
                                    </div>

                                </div>
                                <div class="col-md-6">
                                    <label class="control-label" for="txt_Accountnumber4">Número de cuenta 4:</label>
                                    <div class="input-group">
                                        <input type="text" id="txt_Accountnumber4" name="txt_Accountnumber4" class="form-control">
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title font-weight-bold" id="modalReportLabel">Reporte del Trabajador</h5>
            ...
            <div class="modal-body">
                ...
                <div class="d-flex justify-content-between  align-items-center">
                    <!-- Nombre -->
                    <div>
                        <h3 class="text-uppercase font-weight-bold text-primary" id="reportTitle">REPORTE</h3>
                    </div>
                    <!-- Foto de Perfil -->
                    <div>
                ...
                <!-- Datos Personales -->
                <h6 class="text-uppercase font-weight-bold text-danger mt-4">Datos de Trabajador</h6>
                <hr>
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            <td><strong>Codigo Trabajador</strong></td>
                            <td id="reportCodeCustomer">#12345678</td>
                        </tr>
                        <tr>
                            <td><strong>Estado</strong></td>
                            <td id="reportStatusCustomer">12345678</td>
                        </tr>
                    </tbody>
                </table>
                <!-- Datos Personales -->
                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td id="reportEmail">emersonaragis@gmail.com</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><strong>Número de cuenta 1</strong></td>
                            <td id="reportNumberAccount">123456785554</td>
                        </tr>
                        <tr>
                            <td><strong>Número de cuenta 2</strong></td>
                            <td id="reportNumberAccount2">123456785554</td>
                        </tr>
                        <tr>
                            <td><strong>Número de cuenta 3</strong></td>
                            <td id="reportNumberAccount3">123456785554</td>
                        </tr>
                        <tr>
                            <td><strong>Número de cuenta 4</strong></td>
                            <td id="reportNumberAccount4">123456785554</td>
                        </tr>
                        <tr>
                            <td><strong>Cargo</strong></td>
                            <td id="reportJobTitle">Contador</td>
                        </tr>
                    </tbody>
                </table>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success text-white">
                <h5 class="modal-title" id="modalUpdateLabel">Registro del trabajador</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <div class="tile-body">
                    <form id="formUpdate" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="update_txtDni" hidden>NÚMERO DE DOCUMENTO
                                <span class="text-danger">*</span>
                            </label>
                            <div class="input-group">
                        ...
                        <div class="form-group">
                            <label class="control-label" for="update_selectJobtitle">Cargo:</label>
                            <span class="text-danger">*</span>
                            <select id="update_selectJobtitle" name="update_selectJobtitle" class="form-control" required>
                                <option value="">Seleccione un cargo</option>
                                <?php foreach ($data['jobtitle'] as $jobtitle) : ?>
                                    <option value="<?= $jobtitle['id'] ?>"><?= $jobtitle['name'] ?></option>
                                <?php endforeach; ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label class="control-label" for="update_txtAccountnumber">Número de cuenta 1:</label>
                                <span class="text-danger">*</span>
                                <div class="input-group">
                            ...
                            <div class="col-md-6">
                                <label class="control-label" for="update_txtAccountnumber2">Número de cuenta 2:</label>
                                <div class="input-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label class="control-label" for="update_txtAccountnumber3">Número de cuenta 3:</label>
                                <div class="input-group">
                                    <input type="text" id="update_txtAccountnumber3" name="update_txtAccountnumber3" class="form-control">
                                </div>

                            </div>
                            <div class="col-md-6">
                                <label class="control-label" for="update_txtAccountnumber4">Número de cuenta 4:</label>
                                <div class="input-group">
                                    <input type="text" id="update_txtAccountnumber4" name="update_txtAccountnumber4" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
