...
<main class="app-content">
    <div class="app-title pt-5">
        <div>
            <h1><i class="fa fa-flag-checkered" aria-hidden="true"></i> <?= $data["page_title"] ?></h1>
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header bg-warning text-white">
                <h5 class="modal-title font-weight-bold" id="modalPermissionLabel">Gestion de permisos</h5>
                <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-body">
                ...
                <div class="p-3 bg-light border rounded mb-3">
                    <h5 class="text-center font-weight-bold mb-3">Información adicionales</h5>
                    <div class="row">
                ...
                <button type="button" class="btn btn-warning btn-block" id="btn-send-permission"> <i
                        class="fa fa-save"></i>
                    Guardar</button>
            </div>
            <!-- Pie del Modal -->
