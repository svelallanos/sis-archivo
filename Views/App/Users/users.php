                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="txtFullName" name="txtFullName" required
            ...
            <div class="modal-body">
                ...
                <table class="table table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <td><strong>Constraseña</strong></td>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="update_txtFullName"
                                        name="update_txtFullName" required placeholder="Ingrese sus nombres completos"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="update_slctRole" name="update_slctRole" required>
                                        <option value="" selected disabled>Seleccione un elemento</option>
                                    </select>
                                </div>
                            </div>
