...
-- Volcando estructura para tabla bd_archivo.tb_area
DROP TABLE IF EXISTS `tb_area`;
CREATE TABLE IF NOT EXISTS `tb_area` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `management_tool_id` int(11) NOT NULL,
  `name` text NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `FK_tb_area_tb_management_tool` (`management_tool_id`),
  CONSTRAINT `FK_tb_area_tb_management_tool` FOREIGN KEY (`management_tool_id`) REFERENCES `tb_management_tool` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;

-- Volcando datos para la tabla bd_archivo.tb_area: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_archivo.tb_interface: ~12 rows (aproximadamente)
INSERT INTO `tb_interface` (`idInterface`, `i_name`, `i_description`, `i_url`, `i_isOption`, `i_isPublic`, `i_isListNav`, `i_status`, `i_registrationDate`, `i_updateDate`, `module_id`) VALUES
	...
	(5, 'Listado de Logs', NULL, 'logs', '0', '0', '1', 'Activo', '2025-01-31 21:49:03', '2025-08-28 19:54:19', 2),
	...
	(8, 'Instrumento de Gestión', NULL, 'management', '0', '0', '1', 'Activo', '2025-08-28 20:52:42', '2025-08-28 20:52:57', 1),
...
CREATE TABLE IF NOT EXISTS `tb_job_title` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `management_tool_id` int(11) DEFAULT NULL,
  ...
  `dateUpdate` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `FK_tb_job_title_tb_management_tool` (`management_tool_id`),
  CONSTRAINT `FK_tb_job_title_tb_management_tool` FOREIGN KEY (`management_tool_id`) REFERENCES `tb_management_tool` (`id`)
...
-- Volcando datos para la tabla bd_archivo.tb_log: ~29 rows (aproximadamente)
INSERT INTO `tb_log` (`idLog`, `l_title`, `l_description`, `l_registrationDate`, `l_updateDate`, `typelog_id`, `user_id`) VALUES
	...
	(12, 'Inicio de sesion exitoso', 'El usuario Super Admin, completo de manera satisfactoria el inicio de sesion', '2025-08-28 19:31:49', '2025-08-28 19:31:49', 2, 1),
	(13, 'Información de navegación', 'El usuario entro a :Panel de control', '2025-08-28 19:31:51', '2025-08-28 19:31:51', 3, 1),
	(14, 'Información de navegación', 'El usuario entro a :Panel de control', '2025-08-28 19:36:42', '2025-08-28 19:36:42', 3, 1),
	(15, 'Información de navegación', 'El usuario entro a :Panel de control', '2025-08-28 19:36:45', '2025-08-28 19:36:45', 3, 1),
	(16, 'Tiempo de inactividad', 'El usuario ha estado inactivo durante -Tiempo inactivo: 16 minutos y 31 segundos.', '2025-08-28 19:53:19', '2025-08-28 19:53:19', 3, 1),
	(17, 'Información de navegación', 'El usuario entro a :Panel de control', '2025-08-28 19:54:21', '2025-08-28 19:54:21', 3, 1),
	(18, 'Información de navegación', 'El usuario entro a :Gestión de Personas', '2025-08-28 19:55:11', '2025-08-28 19:55:11', 3, 1),
	(19, 'Información de navegación', 'El usuario entro a :Gestión de Trabajadores', '2025-08-28 19:55:26', '2025-08-28 19:55:26', 3, 1),
	(20, 'Tiempo de inactividad', 'El usuario ha estado inactivo durante -Tiempo inactivo: 1 minutos y 49 segundos.', '2025-08-28 19:57:40', '2025-08-28 19:57:40', 3, 1),
	(21, 'Información de navegación', 'El usuario entro a :Gestión de Trabajadores', '2025-08-28 19:58:30', '2025-08-28 19:58:30', 3, 1),
	(22, 'Tiempo de inactividad', 'El usuario ha estado inactivo durante -Tiempo inactivo: 2 minutos y 1 segundos.', '2025-08-28 20:00:48', '2025-08-28 20:00:48', 3, 1),
	(23, 'Navegación en módulo', 'El usuario ingresó al módulo: Cargos del Personal', '2025-08-28 20:00:49', '2025-08-28 20:00:49', 3, 1),
	(24, 'Registro exitoso', 'Se registró un nuevo cargo: {"token":"31da7d5f82089e44fc54-da971dc643304aa0fd56-1bc02aabf9a93f10317a-c8a213c2713bcc71e625","txtName":"Invitado","txtJobtitleDescription":""}', '2025-08-28 20:01:28', '2025-08-28 20:01:28', 2, 1),
	(25, 'Información de navegación', 'El usuario entro a :Gestión de Trabajadores', '2025-08-28 20:01:39', '2025-08-28 20:01:39', 3, 1),
	(26, 'Información de navegación', 'El usuario entro a :Gestión de Personas', '2025-08-28 20:01:49', '2025-08-28 20:01:49', 3, 1),
	(27, 'Registro exitoso', 'Perfil registrado correctamente', '2025-08-28 20:02:24', '2025-08-28 20:02:24', 2, 1),
	(28, 'Información de navegación', 'El usuario entro a :Gestión de Trabajadores', '2025-08-28 20:02:34', '2025-08-28 20:02:34', 3, 1),
	(29, 'Tiempo de inactividad', 'El usuario ha estado inactivo durante -Tiempo inactivo: 23 minutos y 24 segundos.', '2025-08-28 20:26:24', '2025-08-28 20:26:24', 3, 1),
	(30, 'Información de navegación', 'El usuario entro a :Gestión de Trabajadores', '2025-08-28 20:44:38', '2025-08-28 20:44:38', 3, 1),
	(31, 'Ocurrio un error inesperado', 'Error: SQLSTATE[42S22]: Column not found: 1054 Unknown column \'w.account_number\' in \'field list\' - 42S22', '2025-08-28 20:44:39', '2025-08-28 20:44:39', 1, 1),
	(32, 'Tiempo de inactividad', 'El usuario ha estado inactivo durante -Tiempo inactivo: 18 minutos y 7 segundos.', '2025-08-28 20:44:40', '2025-08-28 20:44:40', 3, 1),
	(33, 'Tiempo de inactividad', 'El usuario ha estado inactivo durante -Tiempo inactivo: 6 minutos y 5 segundos.', '2025-08-28 20:50:49', '2025-08-28 20:50:49', 3, 1),
	(34, 'Información de navegación', 'El usuario entro a :Gestión de Trabajadores', '2025-08-28 20:55:54', '2025-08-28 20:55:54', 3, 1),
	(35, 'Ocurrio un error inesperado', 'Error: SQLSTATE[42S22]: Column not found: 1054 Unknown column \'w.account_number\' in \'field list\' - 42S22', '2025-08-28 20:55:55', '2025-08-28 20:55:55', 1, 1),
	(36, 'Tiempo de inactividad', 'El usuario ha estado inactivo durante -Tiempo inactivo: 4 minutos y 36 segundos.', '2025-08-28 20:55:56', '2025-08-28 20:55:56', 3, 1),
	(37, 'Información de navegación', 'El usuario entro a :Gestión de Trabajadores', '2025-08-28 20:56:17', '2025-08-28 20:56:17', 3, 1),
	(38, 'Ocurrio un error inesperado', 'Error: SQLSTATE[42S22]: Column not found: 1054 Unknown column \'w.account_number\' in \'field list\' - 42S22', '2025-08-28 20:56:17', '2025-08-28 20:56:17', 1, 1),
	(39, 'Información de navegación', 'El usuario entro a :Gestión de Instrumentos', '2025-08-28 21:04:29', '2025-08-28 21:04:29', 3, 1),
	(40, 'Cierre de sesion forzado', 'La cuenta no tiene permiso a ingresar en esta vist, por lo que se esta forzando a cerrar sesion', '2025-08-28 21:04:30', '2025-08-28 21:04:30', 3, 1),
	(41, 'Tiempo de inactividad', 'El usuario ha estado inactivo durante -Tiempo inactivo: 8 minutos y 14 segundos.', '2025-08-28 21:04:36', '2025-08-28 21:04:36', 3, 1),
	(42, 'Tiempo de inactividad', 'El usuario ha estado inactivo durante -Tiempo inactivo: 1 minutos y 12 segundos.', '2025-08-28 21:05:48', '2025-08-28 21:05:48', 3, 1),
	(43, 'Tiempo de inactividad', 'El usuario ha estado inactivo durante -Tiempo inactivo: 2 minutos y 33 segundos.', '2025-08-28 21:08:21', '2025-08-28 21:08:21', 3, 1),
	(44, 'Tiempo de inactividad', 'El usuario ha estado inactivo durante -Tiempo inactivo: 3 minutos y 22 segundos.', '2025-08-28 21:11:43', '2025-08-28 21:11:43', 3, 1),
	(45, 'Información de navegación', 'El usuario entro a :Gestión de Instrumentos', '2025-08-28 21:11:46', '2025-08-28 21:11:46', 3, 1),
	(46, 'Cierre de sesion forzado', 'La cuenta no tiene permiso a ingresar en esta vist, por lo que se esta forzando a cerrar sesion', '2025-08-28 21:11:46', '2025-08-28 21:11:46', 3, 1),
	(47, 'Información de navegación', 'El usuario entro a :Gestión de Instrumentos', '2025-08-28 21:11:46', '2025-08-28 21:11:46', 3, 1),
	(48, 'Cierre de sesion forzado', 'La cuenta no tiene permiso a ingresar en esta vist, por lo que se esta forzando a cerrar sesion', '2025-08-28 21:11:47', '2025-08-28 21:11:47', 3, 1);

-- Volcando estructura para tabla bd_archivo.tb_management_tool
DROP TABLE IF EXISTS `tb_management_tool`;
CREATE TABLE IF NOT EXISTS `tb_management_tool` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` text NOT NULL,
...
-- Volcando datos para la tabla bd_archivo.tb_management_tool: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla bd_archivo.tb_people: ~1 rows (aproximadamente)
INSERT INTO `tb_people` (`id`, `name`, `fullname`, `lastname`, `numberDocument`, `typePeople`, `birthdate`, `gender`, `mail`, `phone`, `address`, `comment`, `dateRegistration`, `dateUpdate`, `status`) VALUES
	(51, 'SAMUEL', NULL, 'VELA LLANOS', '71116734', 'NATURAL', '2025-08-28', 'MASCULINO', 'svelallanos@gmail.com', '924601283', 'Jr. Iquitos #251', '', '2025-08-28 20:02:24', '2025-08-28 20:02:24', 'ACTIVO');
...
-- Volcando datos para la tabla bd_archivo.tb_userroledetail: ~12 rows (aproximadamente)
INSERT INTO `tb_userroledetail` (`idUserRoleDetail`, `interface_id`, `role_id`, `urd_status`, `urd_registrationDate`, `urd_updateDate`) VALUES
	...
	(51, 8, 1, 'Activo', '2025-08-28 20:56:13', '2025-08-28 20:56:13');
...
CREATE TABLE IF NOT EXISTS `tb_worker` (
  ...
  KEY `FK_tb_worker_tb_area` (`area_id`),
  CONSTRAINT `FK_tb_worker_tb_area` FOREIGN KEY (`area_id`) REFERENCES `tb_area` (`id`),
